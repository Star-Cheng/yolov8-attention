...
if __name__ == "__main__":
    model = YOLO(r"C:\Users\13359\PycharmProjects\Yolo\yolov8-attention\runs\detect\results\yolov8_ca_forniture\weights\best.pt")
    img = cv2.imread(r"./dataset/test.jpg")
